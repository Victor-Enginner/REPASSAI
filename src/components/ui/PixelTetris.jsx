...
const FALLBACK_COLORS = ["#6366f1", "#ec4899", "#38bdf8", "#ffffff"];
...
/**
 * PixelTetris - OriginKit Component (Otimizado para REPASS Agentic Console)
 * Respeita prefers-reduced-motion, pausa no document.hidden e aplica opacidade máxima controlada (0.14 / 0.22)
 */
export default function PixelTetris(props) {
  ...
  useEffect(() => {
    ...
    const at = (col, row) => grid[row * cols + col];
    ...
    // Handler para pausar quando a aba estiver inativa
  ...
  return (
    <div
      style={{
        ...
        overflow: "hidden",
        pointerEvents: "none",
        opacity: Math.min(0.22, opacity),
        zIndex: 0,
        maskImage: "linear-gradient(180deg, rgba(0,0,0,1) 0%, rgba(0,0,0,0.2) 100%)",
