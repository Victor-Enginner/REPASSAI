  ...
  return (
    <div style={{ position: 'relative', padding: '36px 40px', maxWidth: '1400px', margin: '0 auto', minHeight: '100vh', animation: 'fadeIn 0.3s ease' }}>
      ...
      <div style={{ position: 'relative', zIndex: 10 }}>
        ...
        <div className="glass-panel" style={{ padding: '28px', marginBottom: '28px', background: 'var(--bg-surface)', border: '0.5px solid var(--sobre-12)' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
            <h2 className="font-headline" style={{ fontSize: '18px', color: 'var(--fg-white)' }}>
              Funil de conversão
            </h2>
            
            <div style={{ background: 'var(--bg-card)', border: '0.5px solid var(--sobre-12)', padding: '10px 20px', borderRadius: '50px', display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(96px, 1fr))', gap: '12px', marginBottom: '28px' }}>
            ...
            <div style={{ background: 'linear-gradient(180deg, rgba(239, 68, 68, 0.25) 0%, rgba(239, 68, 68, 0.05) 100%)', padding: '20px 14px', textAlign: 'center', border: '0.5px solid rgba(239, 68, 68, 0.3)' }}>
              <div className="font-headline" style={{ fontSize: '28px', color: 'var(--estado-erro)' }}>{perdidos}</div>
            ...
            {/* Convertidos */}
            <div style={{ background: 'var(--estado-sucesso-suave)', padding: '20px 14px', textAlign: 'center', border: '0.5px solid var(--accent-indigo)' }}>
              <div className="font-headline" style={{ fontSize: '28px', color: 'var(--accent-indigo)' }}>{convertidos}</div>
              <div style={{ fontSize: '11px', fontWeight: '700', color: 'var(--fg-bright)', marginTop: '6px' }}>Convertidos</div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', paddingTop: '20px', borderTop: '0.5px solid var(--sobre-12)', fontSize: '12.5px', lineHeight: 1.6 }}>
            ...
            <div style={{ color: 'var(--fg-soft)' }}>
              <strong style={{ color: 'var(--estado-erro)' }}>● Taxa de perdidos (Perdidos / Abordados)</strong> — Taxa de perda indica problema no script ou no perfil dos leads sendo abordados.
            </div>
          </div>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '28px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
            ...
            {/* Funil de Leads Bars */}
            <div className="glass-panel" style={{ padding: '24px', background: 'var(--bg-surface)', border: '0.5px solid var(--sobre-12)' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                {[
                  ...
                  { label: 'Perdido', count: perdidos, color: 'var(--estado-erro)' }
                ].map(item => (
                  <div key={item.label} style={{ display: 'flex', alignItems: 'center', gap: '12px', fontSize: '12px' }}>
                    ...
                    <div style={{ flex: 1, height: '8px', background: 'var(--sobre-08)', overflow: 'hidden' }}>
            ...
            <div className="glass-panel" style={{ padding: '24px', background: 'var(--bg-surface)', border: '0.5px solid var(--sobre-12)' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                {recentLeads.map(l => (
                  <div key={l.id} style={{ padding: '10px 12px', background: 'var(--bg-card)', border: '0.5px solid var(--sobre-08)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
            ...
            <div className="glass-panel" style={{ padding: '24px', background: 'var(--bg-surface)', border: '0.5px solid var(--sobre-12)' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                <div style={{ padding: '12px', background: 'rgba(239, 68, 68, 0.1)', border: '0.5px solid rgba(239, 68, 68, 0.3)' }}>
                  <div style={{ fontSize: '12px', fontWeight: '700', color: 'var(--estado-erro)' }}>🔴 Conversão abaixo de 10%</div>
                ...
                <div style={{ padding: '12px', background: 'rgba(239, 68, 68, 0.1)', border: '0.5px solid rgba(239, 68, 68, 0.3)' }}>
                  <div style={{ fontSize: '12px', fontWeight: '700', color: 'var(--estado-erro)' }}>🔴 100% dos leads usados</div>
            ...
            <div className="glass-panel" style={{ padding: '24px', background: 'var(--bg-surface)', border: '0.5px solid var(--sobre-12)' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: '12px', borderTop: '0.5px solid var(--sobre-08)', fontSize: '11px', color: 'var(--fg-muted)' }}>
