...
import { LogIn, UserPlus, RefreshCw, AlertCircle, MailCheck, ShieldCheck } from 'lucide-react';
      ...
      <div style={{ position: 'relative', zIndex: 1, width: '100%', maxWidth: '410px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '28px' }}>
          ...
          <p style={{ fontSize: '13px', color: '#94a3b8', marginTop: '8px' }}>
            {modo === 'entrar' ? 'Entre para acessar seus leads.' : 'Crie sua conta de operador.'}
          </p>
        </div>
        ...
        >
          <div style={{ display: 'flex', gap: '4px', background: '#05070f', padding: '3px', borderRadius: '4px', marginBottom: '22px' }}>
            {[['entrar', 'ENTRAR'], ['cadastrar', 'CRIAR CONTA']].map(([id, rotulo]) => (
              <button
                key={id}
                type="button"
          ...
          <label style={{ display: 'block', marginBottom: '20px' }}>
            <span className="mono-label" style={{ fontSize: '10px', color: '#64748b', display: 'block', marginBottom: '7px' }}>SENHA</span>
            <input
